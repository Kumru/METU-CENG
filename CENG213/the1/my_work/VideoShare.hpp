...
private:
    ...
    Node<Video>* findVideo(const string & videoTitle);
    void bubbleSortLinkedListbyTitle(LinkedList<Video*> *subs, size_t length);
    bool isConnectedRecursive(LinkedList<User*> *traversed, const string & userName1, const string & userName2);
    bool isTraversed(LinkedList<User*> *traversed, const string & userName);
