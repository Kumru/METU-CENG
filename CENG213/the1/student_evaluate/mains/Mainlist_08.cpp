...
int main(int argc, char* argv[]){
    ...
    for (int i = 0; i < 10; ++i){
        list.insertNode(list.getHead(),tmpClass(SSTR(i), rand()%10));
    }
    list.print();
    
    Node<tmpClass>* node1= list.findNode(list.getHead()->getNext()->getData());
    Node<tmpClass>* node2= list.findNode(list.getHead()->getNext()->getNext()->getNext()->getData());
