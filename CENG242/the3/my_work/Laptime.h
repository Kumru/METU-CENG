...
public:
	...
	int getLaptime() const { return laptime; }
	void setLaptime(int newTime) { laptime = newTime; }
	Laptime* getNext() const { return next; }
	void setNext(Laptime* newNext) { next = newNext; }
