...
public:
	...
	Player(unsigned id,int x, int y, Team team);
	...
	virtual std::vector<Coordinate> getAttackableCoordinates() { return std::vector<Coordinate>(); }
	 ...
	 */
	virtual std::vector<Coordinate> getMoveableCoordinates(){ return std::vector<Coordinate>(); }
	 ...
	 */
	virtual std::vector<Coordinate> getHealableCoordinates(){ return std::vector<Coordinate>(); }
